...
- **Resultado de una acción:** al lado del botón, un párrafo `aria-live` que existe siempre, vacío mientras no pase nada, en 700 a 0.95rem y verde confirmado: «Guardado.», «Listo, …». Sólo el éxito: los errores siguen las reglas de «Errores y mensajes». El «Guardado.» se borra en cuanto se vuelve a tocar un campo de esa ficha. Mientras guarda, el botón dice «Guardando…».
